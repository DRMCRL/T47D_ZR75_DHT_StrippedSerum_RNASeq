...
Across all libraries, reads were between `r pander(range(getModule(rawFqc, "Sequence_Length")$Length))` bases.
This does indicate some read trimmig had been performed prior to that undertaken here.
